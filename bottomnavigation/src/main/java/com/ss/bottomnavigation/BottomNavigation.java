...
public class BottomNavigation extends LinearLayout implements OnTabItemClickListener {
    ...
    public void setSelectedItemPositionWithoutNotifyListener(int selectedItemPosition) {
        tabItems.get(this.selectedItemPosition).setSelected(false);
        tabItems.get(selectedItemPosition).setSelected(true);
